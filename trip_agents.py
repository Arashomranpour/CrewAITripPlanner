...
class TripAgents:
    ...
    def city_selection_agent(self):
        return Agent(
            ...
            backstory="An expert in analyzing travel data to pick ideal destinations ,who knows iran very well",
    ...
    def local_expert(self):
        ...
        about the city, it's attractions and customs , who knows iran very well""",
            tools=[self.search_tool, self.browser_tool],
            allow_delegation=False,
            llm=self.llm,
            verbose=True,
    ...
    def travel_concierge(self):
        ...
        decades of experience , who knows iran very well""",
